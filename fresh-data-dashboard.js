...
// Scraping function with fresh data focus
async function scrapeData() {
  ...
  try {
    ...
    console.log('🔄 Refreshing page to get latest data...');
    ...
    if (dataTable && maxRows > 1) {
      ...
      // Log the first item to check if it's fresh
      if (extractedData.length > 0) {
        console.log(`🆕 First item: ID ${extractedData[0].id}, Time: ${extractedData[0].testTime}`);
      }
...
app.listen(PORT, () => {
  console.log(`🚀 Fresh Data Dashboard running at http://localhost:${PORT}`);
  console.log('📊 Open your browser and navigate to http://localhost:3000');
  console.log('🔄 This dashboard focuses on getting the latest data');
