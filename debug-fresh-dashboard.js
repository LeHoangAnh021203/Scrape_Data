...
// Scraping function with detailed logging
        ...
        try {
          ...
          if (cells.length >= 11) {
            ...
            if (id) {
              ...
              console.log(`✅ Extracted item ${i}: ID ${id}, Time: ${testTime}`);
            } else {
...
app.listen(PORT, () => {
  console.log(`🚀 Debug Fresh Dashboard running at http://localhost:${PORT}`);
  console.log('📊 Open your browser and navigate to http://localhost:3000');
  console.log('🔍 This dashboard will show detailed logging');
